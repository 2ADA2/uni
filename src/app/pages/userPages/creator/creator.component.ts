...
export class CreatorComponent {
  ...
  ngOnInit() {
    this.userService.getData().then(res => this.userData = res)
    ...
    this.form.valueChanges.subscribe((value) => {
      this.postData.header = value.header;
      this.postData.src = value.src;
      this.postData.text = value.text;
    })
  }
